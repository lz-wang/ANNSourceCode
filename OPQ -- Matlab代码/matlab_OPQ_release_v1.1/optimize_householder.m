...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% An implementation of "balancing the components’ variance" via optimizing
%%% a householder matrix, as suggested in
%%% Jegou et al. CVPR 2010 "Aggregating local descriptors into 
%%% a compact image representation"
%%% (implemented by Kaiming)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
